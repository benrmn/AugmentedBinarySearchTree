...
private:
	...
	BinaryNode<Comparable>* getP(BinaryNode<Comparable>* z);
	BinaryNode<Comparable>* findP(BinaryNode<Comparable>* t, BinaryNode<Comparable>* p);

	/*------------------Members-----------------------------*/
	//AugmentedBinarySearchTree<Comparable> m_tree;
